...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        echo '<td>'.'<form action="#" method="post"> <input type="hidden" name="usapp" value="'.$row['username'].'" /><input type="submit" value="Approve" class="btn-default" /></form>'.'</td>';
          echo '<td>'.'<form action="viewuser.php" method="post"> <input type="hidden" name="userid" value="'.$row['id'].'" /><input type="hidden" name="fromreq" value="'.$row['id'].'" /><input  type="submit" value="View" class="btn-default" /></form>'.'</td>';
          echo '<td>'.'<form action="edituser.php" method="post"> <input type="hidden" name="userid" value="'.$row['id'].'" /><input  type="submit" value="Edit" class="btn-default" /></form>'.'</td>';
